...
/*	{ 1,	211,	NULL,	"RPL_STATSLINKINFO",	&irc_c_error,
	...
	/*[ ]  /stats M -> modules */
	{ 1,	212,	NULL,	"RPL_STATS",		&irc_c_list,	IRC_LISTSTA,	0 },
	/*[*] /stats C -> connect() */
	{ 1,	213,	NULL,	"RPL_STATS_EXT",	&irc_c_list,	IRC_LISTSTA,	0 },
	/*[*] /stats I -> I:lines */
	{ 1,	215,	NULL,	"RPL_STATS_EXT",	&irc_c_list,	IRC_LISTSTA,	0 },
	/*[*] /stats K -> K:lines */
	{ 1,	216,	NULL,	"RPL_STATS_EXT",	&irc_c_list,	IRC_LISTSTA,	0 },
	/*[*] /stats Y -> classes */
	{ 1,	218,	NULL,	"RPL_STATS",		&irc_c_list,	IRC_LISTSTA,	0 },
	{ 1,	219,	NULL,	"RPL_STATSEND",		&irc_c_list,	IRC_LISTSTA|IRC_LISTEND,	0 },
	/*[*] /stats P -> ports */
	{ 1,	220,	NULL,	"RPL_STATS_EXT",	&irc_c_list,	IRC_LISTSTA,	0 },
	/*[*] /stats A */
	{ 1,	226,	NULL,	"RPL_STATS",		&irc_c_list,	IRC_LISTSTA,	0 },
	/*[ ] /stats u -> uptime */
	{ 1,	242,	NULL,	"RPL_STATS",		&irc_c_list,	IRC_LISTSTA,	0 },
	/*[ ] /stats O -> O:lines ; P -> aktywni */
	{ 1,	243,	NULL,	"RPL_STATS_EXT",	&irc_c_list,	IRC_LISTSTA,	0 },
	/*[*] /stats H -> */
	{ 1,	244,	NULL,	"RPL_STATS",		&irc_c_list,	IRC_LISTSTA,	0 },
	/*[*] /stats F, R, T, Z, ? */
	{ 1,	249,	NULL,	"RPL_STATS",		&irc_c_list,	IRC_LISTSTA,	0 },

/*	{ 1,	221,	NULL,	"RPL_UMODEIS",		&irc_c_error,
	{ 1,	234,	NULL,	"RPL_SERVLIST",		&irc_c_error,
	{ 1,	235,	NULL,	"RPL_SERVLISTEND",	&irc_c_error,

	{ 1,250,NULL,"RPL_STATS",&irc_c_list,IRC_LISTSTA,	0 }, [*]
...
/*
	...
	{ 1,	263,	NULL,	"RPL_TRYAGAIN",		&irc_c_error,	IRC_ERR_ONLY1,	0 },

/*	{ 1,	302,	NULL,	"RPL_USERHOST",		&irc_c_error,
	{ 1,	303,	NULL,	"RPL_ISON",		&irc_c_error,	*/

	{ 1,	301,	NULL,	"RPL_AWAY",		&irc_c_error,	IRC_RPL_OTHER,	0 },
	{ 1,	305,	NULL,	"RPL_UNAWAY",		&irc_c_error,	IRC_RPL_ONLY1,	0 },
	{ 1,	306,	NULL,	"RPL_NOWAWAY",		&irc_c_error,	IRC_RPL_ONLY1,	0 },

	{ 1,	311,	NULL,	"RPL_WHOISUSER",	&irc_c_whois,	IRC_WHOIS,	0 },
	{ 1,	312,	NULL,	"RPL_WHOISSERVER",	&irc_c_whois,	IRC_WHOIS,	0 },
	{ 1,	313,	NULL,	"RPL_WHOISOPERATOR",	&irc_c_whois,	IRC_WHOIS,	0 },
	{ 1,	317,	NULL,	"RPL_WHOISIDLE",	&irc_c_whois,	IRC_WHOIS,	0 },
	{ 1,	318,	NULL,	"RPL_ENDOFWHOIS",	&irc_c_whois,	IRC_WHOIS,	0 },
	{ 1,	319,	NULL,	"RPL_WHOISCHANNELS",	&irc_c_whois,	IRC_WHOIS,	0 },
	{ 1,	320,	NULL,	"RPL_WHOISMISC",	&irc_c_whois,	IRC_WHOIS,	0 },
	{ 1,	314,	NULL,	"RPL_WHOWASUSER",	&irc_c_whois,	IRC_WHOWAS,	0 },
	{ 1,	369,	NULL,	"RPL_ENDOFWHOWAS",	&irc_c_whois,	IRC_WHOWAS,	0 },

	/* G->dj I want to keep the names from rfc2812 */
	{ 1,	315,	NULL,	"RPL_ENDOFWHO",		&irc_c_list, IRC_LISTWHO|IRC_LISTEND,	0 },
	{ 1,	352,	NULL,	"RPL_WHOREPLY",		&irc_c_list, IRC_LISTWHO,	0 },

	/* G->dj: with what it colides ?? */
/*	{ 1,	321,	NULL,	"RPL_LISTSTART",	&irc_c_error,	*/
	{ 1,	321,	NULL,	"RPL_CHLISTSTART",	&irc_c_list, IRC_LISTCHA,	0 },
	{ 1,	322,	NULL,	"RPL_LIST",		&irc_c_list, IRC_LISTCHA,	0 },
	{ 1,	323,	NULL,	"RPL_LISTEND",		&irc_c_list, IRC_LISTCHA|IRC_LISTEND,	0 },
...
/*	{ 1,	351,	NULL,	"RPL_VERSION",		&irc_c_error,	*/
	...
	{ 1,	346,	NULL,	"RPL_INVITELIST",	&irc_c_list,	IRC_LISTINV,	0 },
	{ 1,	347,	NULL,	"RPL_ENDOFLIST",	&irc_c_list,	IRC_LISTINV|IRC_LISTEND,	0 },
	{ 1,	348,	NULL,	"RPL_EXCEPTLIST",	&irc_c_list,	IRC_LISTEXC,	0 },
	{ 1,	349,	NULL,	"RPL_ENDOFLIST",	&irc_c_list,	IRC_LISTEXC|IRC_LISTEND,	0 },

	{ 1,	366,	NULL,	"RPL_ENDOFNAMES",	&irc_c_error,	IRC_RPL_IGNO,	0 },
...
/*	{ 1,	381,	NULL,	"RPL_YOUREOPER",	&irc_c_error,
	...
	{ 1,	401,	NULL,	"ERR_NOSUCHNICK",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	402,	NULL,	"ERR_NOSUCHSERVER",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	403,	NULL,	"ERR_NOSUCHCHANNEL",	&irc_c_error,	IRC_ERR_21,	0 },
/*
 * G->dj: what ? why dya want to put this stuff there ?
+	{ 1,	401,	NULL,	"ERR_NOSUCHNICK",	&irc_c_whois,	IRC_WHOIS  | IRC_WHOERR,	0 },
+	{ 1,	402,	NULL,	"ERR_NOSUCHSERVER",	&irc_c_whois,	IRC_WHOIS  | IRC_WHOERR,	0 },
+	{ 1,	403,	NULL,	"ERR_NOSUCHCHANNEL",	&irc_c_whois,	IRC_WHOIS  | IRC_WHOERR,	0 },
+	{ 1,	406,	NULL,	"ERR_WASNOSUCHNICK",	&irc_c_whois,	IRC_WHOWAS | IRC_WHOERR,	0 },
+
*/
	{ 1,	404,	NULL,	"ERR_CANNOTSENDTOCHAN",	&irc_c_error,	IRC_ERR_OTHER,	0 },
	{ 1,	404,	NULL,	"ERR_CANNOTSENDTOCHAN",	&irc_c_error,	IRC_ERR_OTHER,	0 },
	{ 1,	405,	NULL,	"ERR_TOOMANYCHANNELS",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	406,	NULL,	"ERR_WASNOSUCHNICK",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	407,	NULL,	"ERR_TOOMANYTARGETS",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	408,	NULL,	"ERR_NOSUCHSERVICE",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	409,	NULL,	"ERR_NOORIGIN",		&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	411,	NULL,	"ERR_NORECIPIENT",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	412,	NULL,	"ERR_NOTEXTTOSEND",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	413,	NULL,	"ERR_NOTOPLEVEL",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	414,	NULL,	"ERR_WILDTOPLEVEL",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	415,	NULL,	"ERR_BADMASK",		&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	421,	NULL,	"ERR_UNKNOWNCOMMAND",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	422,	NULL,	"ERR_NOMOTD",		&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	423,	NULL,	"ERR_NOADMININFO",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	424,	NULL,	"ERR_FILEERROR",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	431,	NULL,	"ERR_NONICKNAMEGIVEN",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	432,	NULL,	"ERR_ERRONEUSNICKNAME",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	433,	NULL,	"ERR_NICKNAMEINUSE",	&irc_c_error,	IRC_ERR_OTHER,	0 },
	{ 1,	436,	NULL,	"ERR_NICKCOLLISION",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	437,	NULL,	"ERR_UNAVAILRESOURCE",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	441,	NULL,	"ERR_USERNOTINCHANNEL",	&irc_c_error,	IRC_ERR_NEW,	0 },
	{ 1,	442,	NULL,	"ERR_NOTONCHANNEL",	&irc_c_error,	IRC_ERR_21,	0 },
	{ 1,	443,	NULL,	"ERR_USERONCHANNEL",	&irc_c_error,	IRC_ERR_NEW,	0 },
	{ 1,	444,	NULL,	"ERR_NOLOGIN",		&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	445,	NULL,	"ERR_SUMMONDISABLED",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	446,	NULL,	"ERR_USERSDISABLED",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	451,	NULL,	"ERR_NOTREGISTERED",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	461,	NULL,	"ERR_NEEDMOREPARAMS",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	462,	NULL,	"ERR_ALREADYREGISTRED",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	463,	NULL,	"ERR_NOPERMFORHOST",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	464,	NULL,	"ERR_PASSWDMISMATCH",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	465,	NULL,	"ERR_YOUREBANNEDCREEP",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	466,	NULL,	"ERR_YOUWILLBEBANNED",	&irc_c_error,	IRC_ERR_NEW,	0 },
	{ 1,	467,	NULL,	"ERR_KEYSET",		&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	471,	NULL,	"ERR_CHANNELISFULL",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	472,	NULL,	"ERR_UNKNOWNMODE",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	473,	NULL,	"ERR_INVITEONLYCHAN",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	474,	NULL,	"ERR_BANNEDFROMCHAN",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	475,	NULL,	"ERR_BADCHANNELKEY",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	476,	NULL,	"ERR_BADCHANMASK",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	477,	NULL,	"ERR_NOCHANMODES",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	478,	NULL,	"ERR_BANLISTFULL",	&irc_c_error,	IRC_ERR_NEW,	0 },
	{ 1,	481,	NULL,	"ERR_NOPRIVILEGES",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	482,	NULL,	"ERR_CHANOPRIVSNEEDED",	&irc_c_error,	IRC_ERR_12,	0 },
	{ 1,	483,	NULL,	"ERR_CANTKILLSERVER",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	484,	NULL,	"ERR_RESTRICTED",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	485,	NULL,	"ERR_UNIQOPPRIVSNEEDED",&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	491,	NULL,	"ERR_NOOPERHOST",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
	{ 1,	501,	NULL,	"ERR_UMODEUNKNOWNFLAG",	&irc_c_error,	IRC_ERR_ONLY1,	0 },
